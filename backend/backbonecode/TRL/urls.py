...
urlpatterns = [
    ...
    path('jobs/recommendations/', RecommendApplicanttoJob.as_view(), name='job-recommendations'),
    path('job-recommendations/', JobRecommendationsView.as_view(), name='jobslinkedtoapplicants'),
    path('recommendeddetails/<int:id>/', RecommendedJobDetails.as_view(), name='RecommendedJobDetails'),
